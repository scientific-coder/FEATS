...
/*
 An algorithm for computing the inverse normal cumulative distribution function(http://home.online.no/~pjacklam/notes/invnorm/)


code from Jeremy Lea (Research Engineer, Infrastructure Engineering, Transportek, CSIR, South Africa)
I only changed the random_normal generator to use the boost one
*/
#include <math.h>
#ifndef M_1_SQRT2PI /* not in math.h */
#define M_1_SQRT2PI 0.39894228 /* 1/sqrt(2*pi) */
#endif
#ifndef M_1_SQRTPI
#define M_1_SQRTPI 0.564189583547756286948
#endif
#ifndef M_SQRT2PI
#define M_SQRT2PI 2.50662827463100
#endif
...
static boost::normal_distribution<> norm;
return norm(rng);
}
