...
// g++ segmentations_proto_tests.cxx -o segmentations_proto_tests -I../include -lstdc++ -Wall -Wno-sign-compare
...
int main(int argc, char* argv[]){
  ...
  if(!badArgs){
	...
	std::istream_iterator<na_reader<data_type> > b(std::cin), e;
